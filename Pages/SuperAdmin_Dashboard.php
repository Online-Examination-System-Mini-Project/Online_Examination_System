...
<body>
    ...
    <div id="container">
        ...
        echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
        <tr><td><b>S.N.</b></td><td><b>Title</b></td><td><b>Total Marks</b></td><td><b>Time</b></td><td><b>Tag</b></td><td><b>Date</b></td><td></td><td></td><td></td></tr>';
        while($row = mysqli_fetch_array($result)) {
            $eid=$row['eid'];
            $title = $row['title'];
            ...
            $date=$row['date'];
            echo '<tr><td>'.$eid.'</td>';
            echo '<td>'.$title.'</td><td>'.$total_marks.'</td><td>'.$time.'</td><td>'.$tag.'</td><td>'.$date.'</td><td><b><a href="../Pages/SuperAdmin_Dashboard.php?q=20&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Result</b></span></a></b></td><td><b><a href="update.php?q=rmquizbysuperadmin&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
        }
        echo '</table></div></div>';
        }
        ?>
